...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        save_button_action = QAction("Save", self)
        save_button_action.setStatusTip("This is your button")
        toolbar.addAction(save_button_action)

        open_button_action = QAction("Open", self)
        open_button_action.setStatusTip("This is your button")
        toolbar.addAction(open_button_action)

        help_button_action = QAction("Help", self)
        help_button_action.setStatusTip("This is your button2")
        toolbar.addAction(help_button_action)

        about_button_action = QAction("About", self)
        about_button_action.setStatusTip("This is your button2")
        toolbar.addAction(about_button_action)
